            ...
            <div className={`mx-auto w-full border-white/15 bg-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)] backdrop-blur-xl transition-all duration-500 ease-in-out ${isScrolled ? 'max-w-none rounded-none border-b bg-white/15' : 'max-w-7xl rounded-2xl border'}`}>
                    ...
                    <div className="flex items-center gap-2 md:gap-5">
                        ...
                        <div className="hidden items-center gap-2 border-r border-white/10 pr-5 md:flex relative">
                            ...
                            <div className="relative">
                                ...
                                {showLangMenu && (
                                    <div className="absolute right-0 top-12 w-40 rounded-[1.2rem] border border-orange-500/20 bg-[#2d1b2e]/90 p-2 shadow-[0_10px_50px_rgba(255,165,0,0.15)] backdrop-blur-2xl transition-all animate-fade-in z-50 text-white">
                                        <button
                        ...
                        <div className="hidden md:flex items-center gap-2 md:gap-3 relative">
                            ...
                            <div className="relative">
                                ...
                                {showWalletInfo && (
                                    <div className="absolute right-0 top-12 w-72 rounded-[1.5rem] border border-orange-500/20 bg-[#2d1b2e]/90 p-4 shadow-[0_10px_50px_rgba(255,165,0,0.15)] backdrop-blur-2xl transition-all animate-fade-in z-50 text-white">
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden px-4 pb-4 animate-fade-in">
                        <div className="rounded-[1.5rem] border border-orange-500/20 bg-[#2d1b2e]/95 backdrop-blur-2xl p-4 shadow-[0_10px_50px_rgba(255,165,0,0.15)] flex flex-col gap-1">
                            {navLinks.map((link) => {
